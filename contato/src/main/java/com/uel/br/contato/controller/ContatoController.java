...
public class ContatoController {
    private static final String SESSION_FAVORITOS =
            "sessionFavoritos";
    @Autowired
    ...
    public String mostrarFormAtualizar(, Model model) {
...
//    public String favoritarContato(@PathVariable("id") int id,
//                                   HttpServletRequest request){
//        Contato contato = contatoRepository.findById(id)
//                .orElseThrow(() -> new IllegalArgumentException("O id do contato é inválido: " + id));
//
//
//        List<Contato> favoritos = (List<Contato>)
...
//                (List<Contato>)request.getSession().getAttribute(SESSION_FAVORITOS);
//
//
//        if (CollectionUtils.isEmpty(favoritos)) {
//            favoritos = new ArrayList<>();
